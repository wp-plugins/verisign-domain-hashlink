...
= Do I need an invitation to use the service? = 
Yes. Verisign Domain Hashlink requires an invitation key for your website to be activated with the WordPress plugin.

= How do I get an invitation key to use the service? = 
Please email us at <a href="mailto:domainhashlink@verisign.com?subject=VRSN%20WordPress%20Beta%20Request">domainhashlink@verisign.com</a> with your domain name and e-mail address to receive an invitation key for the Verisign Domain Hashlink service.

= What does it mean that Verisign Domain Hashlink is in Beta? =
Like a lot of new kinds of technology, Verisign created Verisign Domain Hashlink because we think it adds value; in this case, to domain names. But the best way to find out is to have people use it and get feedback early in the process. We look forward to any suggestions as we continue to iterate and work towards a full production release. Please send any feedback to: <a href="mailto:domainhashlink@verisign.com?subject=Feedback">domainhashlink@verisign.com</a>

= Where can I find more information about Domain Hashlink? = 
Visit www.domainhashlink.com for more information about Domain Hashlink and complete list of FAQs.

== Screenshots ==

1. This screen shot description corresponds to screenshot-1.(pngjpgjpeggif). Note that the screenshot is taken from
the directory of the stable readme.txt, so in this case, `tags4.3screenshot-1.png` (or jpg, jpeg, gif)
